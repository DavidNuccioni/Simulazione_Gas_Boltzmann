...
def parser_arguments():
    ...
    parser.add_argument('-N', '--part', type=int, action='store', default=200, help='Inserisci il numero di particelle (Default: 3000)')
    parser.add_argument('-v', '--vel', type=float, action='store', default=1.0, help='Inserisci il valore della velocità iniziale')    
...
while running:
    ...
    v_th = np.sqrt(2 * T)
    v_max = 5 * v_th   # copre quasi tutta la distribuzione
    vmax_plot = v_max
